...
The Little Redis Book is licensed under the Attribution-NonCommercial 3.0 Unported license. Non dovresti aver pagato per questo libro.
...
Sei libero di copiare, distribuire, modificare o visualizzare il libro. In ogni caso, ti chiedo di attribuire in ogni caso il libro a me, Karl Seguin, e di non usarlo per scopi commerciali. 

You can see the *full text* of **the license at**:
Puoi visionare il *testo completo* della ***licenza al sito**: 
...
Karl Seguin è uno sviluppatore con una esperienza che spazia attraverso diversi campi e tecnologie. E' un contributor attivo a progetti di Software Open-Source, uno scrittore tecnico e tiene conferenze occasionalmente. Ha scritto diversi articoli, così come alcuni tools, riguardo a Redis. Redis "powers" le classifiche e statistiche del suo servizio gratuito per sviluppatori di videogame occasionali: [mogade.com](http://mogade.com)

Karl ha scritto [The Little MongoDB Book](http://openmymind.net/2011/3/28/The-Little-MongoDB-Book/), il popolare libro gratuito su MongoDB.

His blog can be found at <http://openmymind.net> and he tweets via [@karlseguin](http://twitter.com/karlseguin)
Il suo blog si trova al seguente URL:  <http://openmymind.net> e twitta con [@karlseguin](http://twitter.com/karlseguin)

### With Thanks To

Uno speciale ringraziamento a [Perry Neal](https://twitter.com/perryneal) per avermi prestato i suoi occhi, la sua mente e la sua passione. Mi hai fornito un aiuto inestimabile. Grazie. 
...
Il più recente sorgente di questo libro è disponibile a: 
<http://github.com/karlseguin/the-little-redis-book>
